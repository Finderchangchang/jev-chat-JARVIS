...
dependencies {
    ...
    // The overlay's timing decisions (ForegroundLeaveGate / OverlaySelfHealPolicy)
    // are pure Kotlin on purpose: they are the parts most likely to regress and
    // they must be verifiable without a phone attached.
